              ...
              <Col lg="10" xl="8">
                <div className="px-lg-8 px-xl-3">
                  <div className="single-block mb-11">
                    <p className="gr-text-9">Welcome to AronWorks!</p>

                    <p className="gr-text-9">
                      These terms and conditions outline the rules and
                      regulations for the use of AronWorks's Website, located at
                      https://aronworks.com.
                    </p>

                    <p className="gr-text-9">
                      By accessing this website we assume you accept these terms
                      and conditions. Do not continue to use AronWorks if you do
                    ...
                    <p className="gr-text-9">
                      We employ the use of cookies. By accessing AronWorks, you
                      agreed to use cookies in agreement with the AronWorks's
                      Privacy Policy.{" "}
                    </p>
                    ...
                    <p className="gr-text-9">
                      Unless otherwise stated, AronWorks and/or its licensors
                      own the intellectual property rights for all material on
                      AronWorks. All intellectual property rights are reserved.
                      You may access this from AronWorks for your own personal
                      use subjected to restrictions set in these terms and
                      conditions.
                    </p>

                    <p className="gr-text-9">You must not:</p>
                    <ul>
                      <li>Republish material from AronWorks</li>
                      <li>Sell, rent or sub-license material from AronWorks</li>
                      <li>
                        Reproduce, duplicate or copy material from AronWorks
                      </li>
                      <li>Redistribute content from AronWorks</li>
                    </ul>
                    ...
                    <p className="gr-text-9">
                      You hereby grant AronWorks a non-exclusive license to use,
                    ...
                    <p className="gr-text-9">
                      ...
                      hyperlink compensates the absence of AronWorks; and (d)
                    ...
                    <p className="gr-text-9">
                      ...
                      must inform us by sending an e-mail to AronWorks. Please
                    ...
                    <p className="gr-text-9">
                      No use of AronWorks's logo or other artwork will be
                    ...
                    <p className="gr-text-9">Please read Privacy Policy</p>
